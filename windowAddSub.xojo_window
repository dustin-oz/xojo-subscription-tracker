...
Begin Window windowAddSub
   ...
   Begin Label label_platform
      ...
      Width           =   61
   End
   Begin PopupMenu input_platform
      AllowAutoDeactivate=   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
   ...
   Begin Label label_paymentGateway
      ...
      Width           =   117
   End
   Begin PopupMenu input_paymentGateway
      AllowAutoDeactivate=   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
   ...
   Begin Label label_billingCycle
      ...
      Width           =   110
   End
   Begin PopupMenu input_billingCycle
      AllowAutoDeactivate=   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
   ...
   Begin TextField input_expires
      ...
      Width           =   212
   End
   Begin TextField input_autoRenews
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
      ...
      Width           =   212
   End
   Begin TextField input_purchaseDate
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
...
#tag Events btn_add
	#tag Event
		Sub Action()
		  if input_name.Text.IsEmpty = true then
		    MessageBox("Please enter subscription service name.")
		  Else
